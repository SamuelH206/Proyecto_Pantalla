...
namespace Proyecto_Pantalla
{
    public partial class Registro : Form
    {
        ...
        private void btn_Crear_Click(object sender, EventArgs e)
        {
            ...
            Persona.AgregarPersona(txt_Id.Text,txt_Nombres.Text,txt_Apellidos.Text,ListBox_ListaRol.Text,txt_Correo.Text,txt_Contraseña.Text);
            string Consulta_Rol = "select Rol from Usuario where id = " + txt_Id.Text + ";";
            SqlCommand cmd_ConsultaRol = new SqlCommand(Consulta_Rol, Conexion.Conectar());
            SqlDataReader Roles_Registrados = cmd_ConsultaRol.ExecuteReader();
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (ListBox_ListaRol.Text == "Cliente")
                        {
